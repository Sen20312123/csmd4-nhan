class AppBase {
    ...
    static API_SEARCH = this.API_PRODUCT + "/search?q=";

    static API_CATEGORY = this.API_PRODUCT + "/category";


    static API_CLOUDINARY = 'https://res.cloudinary.com/dpjb4qjf4/image/upload';
...
class ProductDTO{
    constructor(id, productName, price, quantity, description, category, productMedia) {
        this.id = id;
